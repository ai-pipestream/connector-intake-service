...
/**
 * Test resource that configures the repo-service client to connect to MockRepositoryService.
 * 
...
public class RepositoryServiceTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        LOG.info("RepositoryServiceTestResource: Configuring repo-service client for MockRepositoryService");
